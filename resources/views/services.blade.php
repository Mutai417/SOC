...
<footer>
    ...
    <div class="row footer-gap">
      <div class="col-lg-5 mb-lg-0 mb-4">
        ...
        <div class="row mt-4">
          ...
          <div class="col-md-6 mt-md-0 mt-5">
            <h3 class="text-capitalize mb-3">LOCATION</h3>
            <address class="mb-0">
              <p class="mb-2"><i class="fas fa-map-marker"></i> Strath­more University
                <br>
               Stu­dent Centre,Keri Road  <br></p>
              <p><i class="fas mr-1 fa-clock"></i>P.O.Box 59857,00200</p>
              <p><i class="fas mr-1 fa-phone"></i>Timings 8:30 a.m to 5:30 p.m </p>
      ...
      <div class="col-lg-3 col-md-6 mt-lg-0 mt-sm-0 p-md-0">
       ...
       <image class =" iLabAfrica" src="../images/SU.png"width="300" height="80" sizes="40x40" >
